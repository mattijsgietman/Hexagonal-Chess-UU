...
class Chess(gym.Env):
    ...
    def __init__(self) -> None:
        ...
        self._board: Optional[HexBoard.hexboard] = None
    ...
    def reset(self) -> HexBoard.hexboard:

        self._board = HexBoard.hexboard()
        self._ready = True
    ...
    def render(self, mode: str = 'unicode') -> Optional[str]:
        ...
        HexBoard.hexboard.print_hexboard(self._board)
    ...
    def legal_moves(self):
        ...
        return list(self._board.get_legal_moves)
